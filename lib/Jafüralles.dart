...
class JafuerallesPage extends StatefulWidget {
  @override
  _JafuerallesPageState createState() => _JafuerallesPageState();
}

class _JafuerallesPageState extends State<JafuerallesPage> {
  int selectedAge = -1;
